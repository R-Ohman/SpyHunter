...
/*
ÏËÀÍ ÍÀ 4.01
- ñòðóêòóðèçèðîâàòü ïðîãðàììó, ðàçáèòü íà ôóíêöèè, óáðàòü âñå íåíóæíîå
- ïîìåíÿòü ïåðèîä ñïàâíà àâòîìîáèëåé, ñäåëàòü ïðîâåðêó íàëàçèò ëè àâòî íà äðóãîå àâòî
- ñäåëàòü âîçìîæíîñòü ñáèâàòü àâòîìîáèëü ñ äîðîãè
*/
...
// x,y - êîîðäèíàòà íà ïåðèìåòðå ìàøèíû; x2, y2 - öåíòð îáúåêòà
...
// Ïðîâåðêà äëÿ ïèêñåëåé ïî ïåðèìåòðó ìàøèíû, íàõîäèòñÿ ëè ïîçèöèÿ â äðóãîì îáúåêòå.
		...
		if (int(game.distance * 10000) % 181 == 0) {
			...
			for (auto& car : cars) {
				if (car.coord.x == 0 && flag) {
					...
					// Íàä ýêðàíîì íà âûñîòó ñãåíåðèðîâàííîãî àâòî
